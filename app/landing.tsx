...
const features = [
  {
    ...
    description:
      "Track leads, manage pipelines, and close more deals with intelligent customer insights.",
  ...
  },
  {
    ...
    description:
      "Organize tasks, collaborate with your team, and deliver projects on time.",
  ...
  },
  {
    ...
    title: "AI Assistant",
    description:
      "Get intelligent recommendations and automate repetitive business tasks.",
  ...
  },
  {
    ...
    description:
      "Gain actionable insights into your business performance with real-time analytics.",
  ...
  },
  {
    ...
    description:
      "Keep your entire team aligned with integrated communication tools.",
    ...
    <div className="landing-shell min-h-screen [--background:#f7f5ff] [--foreground:#0f172a] [--primary:#6d28d9] [--primary-foreground:#ffffff] [--accent:#c2410c] [--accent-foreground:#ffffff] [--secondary:#047857] [--secondary-foreground:#ffffff]">
      ...
      >
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          <Link
            href="/"
            className="mr-4 flex shrink-0 items-center gap-2 font-bold text-xl transition-transform hover:scale-105 sm:mr-0"
          >
            <Image
              src="/favicon.png"
              alt="FlowPilot logo"
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <Link href="/auth/login">
              ...
              >
                <Button
                  variant="outline"
                  className="border-slate-300 bg-white text-slate-900 hover:bg-violet-50 hover:text-violet-800 dark:border-slate-700 dark:bg-slate-900 dark:text-white dark:hover:bg-slate-800 dark:hover:text-violet-300"
                >
                  Sign in
                </Button>
              </motion.div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32 relative">
        ...
        >
          ...
          <motion.p
            variants={itemVariants}
            className="text-lg md:text-xl text-foreground/70 max-w-2xl mx-auto text-balance"
          >
            All-in-one platform for CRM, project management, and team
            collaboration. Grow your business faster with intelligent
            automation.
          </motion.p>
          ...
          >
            <Link href="/auth/register">
              ...
              >
                <Button
                  size="lg"
                  className="gap-2 bg-gradient-to-r from-primary to-accent text-foreground hover:shadow-lg transition-shadow"
                >
          ...
          <div className="relative mx-auto max-w-5xl px-2 [perspective:1400px] sm:px-8">
            ...
            >
              <div className="flex items-center gap-2 border-b border-slate-200 bg-slate-50 px-4 py-3">
                ...
                <span className="ml-3 rounded-md bg-white px-3 py-1 text-[10px] font-medium text-slate-400 shadow-sm">
                  app.flowpilot.io/dashboard
                </span>
              </div>
              ...
              <div className="grid min-h-72 grid-cols-[54px_1fr] bg-slate-50/80 sm:grid-cols-[150px_1fr]">
                <div className="border-r border-slate-200 bg-white p-3">
                  <div className="mb-5 flex items-center gap-2 text-xs font-bold text-slate-900">
                  ...
                  <div className="space-y-2">
                    {[BarChart3, Users, FolderKanban, Zap].map(
                      (Icon, index) => (
                        <div
                          key={index}
                          className={`flex items-center gap-2 rounded-lg p-2 text-[11px] font-medium ${index === 0 ? "bg-purple-100 text-purple-700" : "text-slate-500"}`}
                        >
                ...
                <div className="min-w-0 p-4 text-left sm:p-5">
                  ...
                  <div className="grid grid-cols-2 gap-2 sm:grid-cols-3">
                    {[
                      ...
                      <motion.div
                        key={label}
                        className={`${index === 2 ? "hidden sm:block" : ""} rounded-xl border border-slate-200 bg-white p-3 shadow-sm`}
                  ...
                  <div className="mt-2 grid gap-2 sm:grid-cols-[1.5fr_1fr]">
                    <div className="rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
                      ...
                      <div className="mt-4 flex h-20 items-end gap-1.5">
                        {[35, 52, 44, 68, 60, 82, 94].map((height, index) => (
                          <motion.div
                            key={index}
                            className="flex-1 rounded-t bg-gradient-to-t from-purple-600 to-purple-300"
                            initial={{ height: 0 }}
                    ...
                    <div className="hidden rounded-xl bg-slate-900 p-3 text-white shadow-sm sm:block">
                      ...
                      <p className="mt-1 text-[9px] leading-4 text-slate-300">
                        Your conversion rate is up 18% this week.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <section
        id="features"
        className="max-w-7xl mx-auto scroll-mt-20 px-4 sm:px-6 lg:px-8 py-20 space-y-12"
      >
        <motion.div
      ...
      <section
        id="pricing"
        className="max-w-7xl mx-auto scroll-mt-20 px-4 sm:px-6 lg:px-8 py-20"
      >
        <motion.div
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/90 text-lg max-w-2xl mx-auto">
              Join thousands of businesses using FlowPilot to streamline their
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
            ...
            <p className="text-sm font-medium text-slate-700 dark:text-slate-300">
              &copy; 2026 FlowPilot. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
